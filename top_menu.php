<div class="header">
            <div class="header-left">
                <a href="index.php" class="logo">
                    <img src="assets/img/logo-ess.png" width="35" height="35" alt=""> <span>ESS</span>
                </a>
            </div>
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown d-none d-sm-block">
                    <a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><i class="fa fa-comment-o"></i> <span class="badge badge-pill bg-danger float-right">4</span></a>
                </li>
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="edit-profile.html">Modifica Profilo</a>
