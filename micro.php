...
<body>
			...
			<div class="content">
				<div class="row">
					<div class="col-sm-8 col-4">
						<h4 class="page-title">Pianificazione Micro attività</h4>
					</div>
  ...
  -->
	...
	<!--GANTT -->
	<script src="assets/js/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
	<script src="assets/js/gantt/libs/jquery/jquery.timers.js"></script>

	<script src="assets/js/gantt/libs/utilities.js"></script>
	<script src="assets/js/gantt/libs/forms.js"></script>
	<script src="assets/js/gantt/libs/date.js"></script>
	<script src="assets/js/gantt/libs/dialogs.js"></script>
	<script src="assets/js/gantt/libs/layout.js"></script>
	<script src="assets/js/gantt/libs/i18nJs.js"></script>
	<script src="assets/js/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
	<script src="assets/js/gantt/libs/jquery/JST/jquery.JST.js"></script>
	<script src="assets/js/gantt/libs/jquery/valueSlider/jquery.mb.slider.js"></script>

	<script type="text/javascript" src="assets/js/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
	<script type="text/javascript" src="assets/js/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


	<script src="assets/js/gantt/libs/ganttUtilities.js"></script>
	<script src="assets/js/gantt/libs/ganttTask.js"></script>
	<script src="assets/js/gantt/libs/ganttDrawerSVG.js"></script>
	<script src="assets/js/gantt/libs/ganttZoom.js"></script>
	<script src="assets/js/gantt/libs/ganttGridEditor.js"></script>
	<script src="assets/js/gantt/libs/ganttMaster.js"></script>
	<script src="assets/js/gantt/app_gantt.js"></script>
